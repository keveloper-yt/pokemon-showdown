...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			'Aipom', 'Diglett-Base', 'Dunsparce', 'Gastly', 'Girafarig', 'Gligar',
			'Magby', 'Meditite', 'Misdreavus', 'Murkrow', 'Porygon', 'Rufflet', 'Scraggy', 'Scyther', 'Sneasel', 
			'Snivy', 'Stantler', 'Vulpix', 'Yanma', 'Moody', 'Heat Rock', 
		],
	},
	{
